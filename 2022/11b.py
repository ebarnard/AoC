...
def run(monkeys):
    modulus = reduce(operator.mul, set((m.test_divisible_by for m in monkeys)), 1)
    ...
    for j in range(10000):
        ...
        if j == 0 or j == 19 or j % 1000 == 999:
            print(j + 1, ":", inspection_count)
...
if __name__ == "__main__":
    assert run(parse("11-test.txt")) == 2713310158
    assert run(parse("11-real.txt")) == 28244037010
